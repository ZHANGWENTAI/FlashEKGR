...
from flashekgr.cpp_sampler.online_sampler import OnlineSampler
from flashekgr.common.util import thread_wrapped_func, log_metrics, eval_tuple
from flashekgr.common.config import name_query_dict, query_name_dict
...
def save_loss(loss, step, filename="/home/zhangwentai/flashekgr/betae_loss.txt"):
    if step % 100 == 0:
